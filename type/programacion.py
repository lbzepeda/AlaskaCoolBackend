...
from models.index import programacion, productos, proforma, det_proforma, usuarios, cuadrillas, usuario_cuadrilla
...
class Programacion:
    ...
    @strawberry.field
    def proforma(self, info: Info) -> typing.List[Optional[Proforma]]:  
        proformas = [Proforma(**dict(proforma._mapping)) for proforma in lstProforma if proforma.NoFactura == self.codproforma]
